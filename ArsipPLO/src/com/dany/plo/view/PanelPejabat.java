...
public class PanelPejabat extends javax.swing.JPanel {
    ...
    private DynamicTableModel<PejabatModel> tableModel;
    ...
    public PanelPejabat() {
        ...
        tableModel = new DynamicTableModel<>(PejabatModel.class);
        tablePejabat.setDynamicModel(tableModel);

    }

    public DynamicTableModel<PejabatModel> getTableModel() {
        return tableModel;
    }
    ...
    public void reload() {
        pejabatController.reload(PAGE_SIZE, this);
    }
    ...
    private void initComponents() {
        ...
        labelWhite1.setText("Daftar Pejabat");
        ...
        jScrollPane1.setViewportView(tablePejabat);
    ...
    private void jPaginationOnPageChange(com.stripbandunk.jwidget.event.PaginationEvent evt) {//GEN-FIRST:event_jPaginationOnPageChange
        ...
        pejabatController.onPageChange(skip, max, this);
    ...
    private void panelCrud1Hapus(com.dany.plo.view.resource.CrudEvent evt) {//GEN-FIRST:event_panelCrud1Hapus
        // TODO add your handling code here:
        pejabatController.crudDelete(this);
    ...
    private void panelCrud1Tambah(com.dany.plo.view.resource.CrudEvent evt) {//GEN-FIRST:event_panelCrud1Tambah
        // TODO add your handling code here:
        pejabatController.crudInsret(this);
        reload();
    ...
    private void panelCrud1Ubah(com.dany.plo.view.resource.CrudEvent evt) {//GEN-FIRST:event_panelCrud1Ubah
        // TODO add your handling code here:
        pejabatController.crudUpdate(this);
        reload();
