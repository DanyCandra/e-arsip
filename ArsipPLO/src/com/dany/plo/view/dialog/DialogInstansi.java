 ...
 * @author Dany Candra
 */
public class DialogInstansi extends javax.swing.JDialog {

    private InstansiModel instansiModel;
    private InstansiController instansiController;
    private boolean update;
    private String tmpId;
    private final String newInfo = "Tambah Data Isntansi";
    private final String updateInfo = "Ubah Data Isntansi";

    /**
     * Creates new form DialogInstansi
     */
    public DialogInstansi() {
        setModal(true);
        initComponents();
    ...
    public void update(InstansiModel model) {
        setTitle(updateInfo);
        labelInformasi.setText(updateInfo);
        update = true;
        tmpId = model.getIdInstans();
        textAlamat.setText(model.getAlamat());
        textNamaInstansi.setText(model.getNamaInstansi());
        textTelepon.setText(model.getTelepon());
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(textNamaInstansi, javax.swing.GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(textNamaInstansi, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
