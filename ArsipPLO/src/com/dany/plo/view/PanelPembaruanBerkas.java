...
import com.dany.plo.controller.PembaruanController;
...
public class PanelPembaruanBerkas extends javax.swing.JPanel {
    ...
    private PembaruanController pembaruanController;

    private String tmpIdArsip;
    private String tmpIdDus;
    ...
    public String getTmpIdArsip() {
        return tmpIdArsip;
    }

    public void setTmpIdArsip(String tmpIdArsip) {
        this.tmpIdArsip = tmpIdArsip;
    }

    public String getTmpIdDus() {
        return tmpIdDus;
    }

    public void setTmpIdDus(String tmpIdDus) {
        this.tmpIdDus = tmpIdDus;
    }
    
    

    public final void initForm() {
        pembaruanController.loadCombobox(this);
    ...
    private void initComponents() {
        ...
        labelWhite1.setText("Pembaruan Berkas Kredit");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(comboPejabat, 0, 241, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        pembaruanController.setParameterDebitur(this);
